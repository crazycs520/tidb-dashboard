...
func GetTotalTimeConsumeTable(startTime, endTime string, db *gorm.DB) (TableDef, error) {
	defs1 := []totalTimeByLabelsTableDef{
		...
		{name: "tidb_batch_client_send", tbl: "tidb_batch_client_send", labels: []string{"instance"}, comment: "The time cost of TiDB kv storage batch client wait request batch"},
		{name: "tidb_batch_client_recv", tbl: "tidb_batch_client_recv", labels: []string{"instance"}, comment: "The time cost of TiDB kv storage batch client wait request batch"},
		// PD
